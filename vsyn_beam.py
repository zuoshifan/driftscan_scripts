...
parser.add_argument('-c', '--case', type=int, choices=range(1, 5), default=1, help='Which array configuration.')
...
conf = ['3x32_0.5', '3x32_1.0', '3x32_2.5', '31_32_33_1.0']
Nconf = len(conf)
...
# Case 4: 31+32+33 v = 1.0
    ...
    Nfeeds2 = 32
    Nfeeds3 = 33
    v1 = (Nfeeds2 - 1) * 1.0 / (Nfeeds1 - 1) # m
    v2 = 1.0 # m
    v3 = (Nfeeds2 - 1) * 1.0 / (Nfeeds3 - 1) # m
