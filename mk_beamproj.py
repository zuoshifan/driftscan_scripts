...
parser.add_argument("-t", "--teldir", default="./yamldriver/proddir/bt/", help="The telescope directory to use.")
parser.add_argument("-o", "--outfile", help="Output map.")
...
if mpiutil.rank0:
    ...
    print "Saving file."
    if not args.outfile:
        outfile1 = 'beamproj.hdf5'
        outfile2 = 'dirtymap.hdf5'
    else:
